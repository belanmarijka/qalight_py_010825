...
student_name = ""  # Ваш код тут

# Task 23. Отримайте всі ключі словника student
student_keys = []  # Ваш код тут
